    ...
    <h1 className="text-4xl md:text-5xl font-bold my-8 text-center">MEET THE TEAM</h1>  
      <div className={`${space.className} flex max-w-screen-2xl h-auto items-center justify-center`}>
        <div className="flex flex-wrap justify-center gap-6 mx-auto my-10">
            ...
            >
              ...
              <Image
                src="/Images/WhatsApp Image 2024-04-13 at 14.27.05_ed22832f.jpg" // Assuming the image is located in the public/Images directory
                fill
                alt="profile picture"
      ...
      <div className="flex flex-wrap justify-center gap-6 mx-auto my-10">
            ...
            >
              <div className="relative w-full h-52 md:h-72">
              <Image
                src="/Images/web.jpg" // Assuming the image is located in the public/Images directory
                fill
                alt="profile picture"
                sizes="(max-width: 640px) 50vw, (max-width: 768px) 50vw, 25vw"
                className="w-full h-full object-cover grayscale rounded-lg"
      ...
      <div className="flex flex-wrap justify-center gap-6 mx-auto my-10">
            ...
            >
              <div className="relative w-full h-52 md:h-72">
              <Image
                src="/Images/IMG_4020.JPG" // Assuming the image is located in the public/Images directory
                fill
                alt="profile picture"
                sizes="(max-width: 640px) 50vw, (max-width: 768px) 50vw, 25vw"
                className="w-full h-full object-cover grayscale rounded-lg"
